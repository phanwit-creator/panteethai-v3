...
<head>
    ...
    <?= seo_meta([
        'title'    => $seoTitle,
        'desc'     => $seoDesc,
        'url'      => APP_URL . '/blog' . ($province ? "?province={$province}" : ''),
...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 py-6 flex gap-8">
        ...
        <main class="flex-1 min-w-0">
            ...
            <nav class="flex justify-center gap-2 mt-8">
                <?php if ($page > 1): ?>
                <a href="?page=<?= $page - 1 ?><?= $province ? "&province={$province}" : '' ?>"
                ...
                <a href="?page=<?= $p ?><?= $province ? "&province={$province}" : '' ?>"
    ...
    <footer class="border-t bg-white mt-4 py-6 text-center text-xs text-gray-400">
